<%-- 
    Document   : TableTinhChat
    Created on : Jun 23, 2019, 6:33:49 PM
    Author     : phongtruong
--%>
...
<div class="table-TinhChat">
    ...
    <div class="pagination">
        ...
        <div class="sohang">
            <label>Số hàng: </label>
            <select id="limit-pageTinhChat" class="pagination-sm">
        ...
        <div class="totalPages">
            <ul id="paginationTinhChat" class="pagination-sm"></ul>
        </div>
    </div>
</div>